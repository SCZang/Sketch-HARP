...
TARGET_CATEGORY = 3   # to be edited sketch category
TARGET_SAMPLE_IDX = 36   # to be edited sketch idx
INJECT_STROKE_EMB_DIR = {
    0: {
            "e": "/workspace/0528-17cate-newpos/sample/stroke_emb/sample_8_10/z_00.npy",
            "p": torch.tensor([0.0, 0.0]).cuda(),
            's':"/workspace/0528-17cate-newpos/sample/stroke_emb/sample_8_10/s_00.npy"
        },
}
        ...
        for batch in dataloader:
            ...
            with torch.no_grad():
                ...
                out_padded_seqs, out_strokes, out_pos = self.sample(
                    seq_z, args,
                    inject_stroke_emb_dir=INJECT_STROKE_EMB_DIR)
